...
| **Path C** | AI premium demos — standalone, reference-quality | `dist/{brand}/premium/` (generated by `scripts/generate-premium.js`) |
...
dist/               Packaged output for deployment
  {brand}/premium/  Premium standalone demos (Path C)
```
