 ...
 * Phase 3 — added campaigns_queries (3), dt_fulfillment_payment (5), retailer_activation (2)
 */
const SCREEN_REGISTRY = {
  ...
  // Campaigns & Queries — 3 steps
  'step1-campaigns_queries': 'step1-campaigns_queries',
  'step2-campaigns_queries': 'step2-campaigns_queries',
  'step3-campaigns_queries': 'step3-campaigns_queries',
  // DT Fulfillment & Payment — 5 steps
  'step1-dt_fulfillment_payment': 'step1-dt_fulfillment_payment',
  'step2-dt_fulfillment_payment': 'step2-dt_fulfillment_payment',
  'step3-dt_fulfillment_payment': 'step3-dt_fulfillment_payment',
  'step4-dt_fulfillment_payment': 'step4-dt_fulfillment_payment',
  'step5-dt_fulfillment_payment': 'step5-dt_fulfillment_payment',
  // Retailer Activation — 2 steps
  'step1-retailer_activation': 'step1-retailer_activation',
  'step2-retailer_activation': 'step2-retailer_activation',
};
